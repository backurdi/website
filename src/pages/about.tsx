    ...
    <section className="px-4 sm:pt-0">
      ...
      <div>
        <p className="mb-5">
          ...
          active. I'm a big fan of fitness, doing BJJ (Brazilian
          Jiu Jitsu), playing Padel tennis, Bouldering, and
          whatever can get the heart pumping. At the same time, I
          love to read, watch movies, and play games. I also love
        ...
        <p className="mb-5">
          ...
          new projects. It's really awesome what we can do these
          days with the internet and the tools we have available.
        </p>

        <p className="mb-5">
          It's been over 7 years since I discovered the world of
          programming. It's a discovery that never stops
          changing. I have become a big fan of TypeScript and
          Next.js. I have started to experiment a lot with
          backend code with Node, and I'm also playing around
          with Python.
        </p>
      </div>
    </section>
